    ...
    <div className="min-h-screen bg-[#0f1419]">
      ...
      <section className="relative pt-14">
        ...
        <div className="relative max-w-4xl mx-auto px-6 py-20 text-center">
          ...
          <p className="text-[#8899a6] max-w-2xl mx-auto leading-relaxed mb-8">
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        <div className="bg-[#1e2a3a] rounded-xl p-8 md:p-12 border border-[#2f3e50]">
          <span className="inline-block px-3 py-1 text-xs font-semibold tracking-wider uppercase bg-[#0f1419] text-[#5ba3a8] rounded-full mb-6">
            OUR MISSION
          </span>
          <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">
            Real-time resource mapping for community care in Minneapolis
          </h2>
          <p className="text-[#8899a6] leading-relaxed max-w-3xl">
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-[#8899a6] max-w-xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {resourceTypes.map((r) => (
            <div
              key={r.label}
              className="bg-[#1e2a3a] rounded-xl p-5 border border-[#2f3e50] flex items-start gap-4"
            >
              <MapPin className="w-5 h-5 text-[#5ba3a8] mt-0.5 flex-shrink-0" />
              <div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {howItWorks.map((step, i) => (
            <div
              key={step.title}
              className="bg-[#1e2a3a] rounded-xl p-6 border border-[#2f3e50] text-center"
            >
              <div className="w-12 h-12 rounded-full bg-[#0f1419] border border-[#2f3e50] flex items-center justify-center mx-auto mb-4">
                <step.icon className="w-5 h-5 text-[#5ba3a8]" />
              </div>
              <span className="text-xs font-bold text-[#5ba3a8] tracking-wider mb-2 block">
                STEP {i + 1}
              </span>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center mb-12">
          {[
            ...
            <div key={stat.label}>
              <p className="text-3xl md:text-4xl font-bold text-[#5ba3a8]">
                {stat.number}
              </p>
              <p className="text-sm text-[#8899a6] mt-1">{stat.label}</p>
            </div>
          ))}
        </div>
        <div className="bg-[#1e2a3a] rounded-xl p-8 border border-[#2f3e50] text-center max-w-3xl mx-auto">
          <p className="text-[#c8d6e0] leading-relaxed">
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {values.map((v) => (
            ...
            >
              <v.icon className="w-6 h-6 text-[#5ba3a8] mb-3" />
              <h3 className="text-lg font-bold text-white mb-2">{v.title}</h3>
              <p className="text-sm text-[#8899a6] leading-relaxed">{v.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-6 py-20">
        <div className="bg-[#1e2a3a] rounded-xl p-8 md:p-12 border border-[#2f3e50] text-center">
          <Mail className="w-8 h-8 text-[#5ba3a8] mx-auto mb-4" />
          <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">
            Get involved
          </h2>
          <p className="text-[#8899a6] max-w-lg mx-auto mb-6 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#5ba3a8] text-[#0f1419] font-semibold rounded-lg hover:bg-[#4a9298] transition-colors"
            >
              Reach out
              <ArrowRight className="w-4 h-4" />
            </a>
            <a
              href="/"
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#2a3a4e] text-white font-semibold rounded-lg hover:bg-[#344a5e] transition-colors"
            >
              Back to the map
              <ArrowRight className="w-4 h-4" />
            </a>
